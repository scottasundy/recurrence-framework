...
- the return is ordinarily to a neighborhood, not to the identical point;
- the statement holds almost everywhere rather than for every point;
- finite accessible measure and measure preservation are required;
- recurrence times may be extremely long;
